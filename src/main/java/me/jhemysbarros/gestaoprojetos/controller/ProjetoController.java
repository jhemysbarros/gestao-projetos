...
public class ProjetoController {
    ...
    public ModelAndView cadastrar() {
        ...
        modelAndView.addObject("lideres", funcionarioRepository.findByCargoNome("Gerente de Projetos"));
        modelAndView.addObject("funcionarios", funcionarioRepository.findByCargoNomeNot("Gerente de Projetos"));
